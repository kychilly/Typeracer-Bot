package com.Discord.DiscordBot.classes;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.Discord.DiscordBot.commands.TyperacerCommand;
...
public class TyperacerPlayer {
    ...
    public ArrayList<String> decodeJSON(String filePath) {
        ...
        try (InputStreamReader reader = new InputStreamReader(
                Objects.requireNonNull(TyperacerPlayer.class.getClassLoader().getResourceAsStream("com/github/DiscordBot/typeracer/" + filePath + ".json")))) {
